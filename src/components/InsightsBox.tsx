...
const InsightsBox: React.FC = () => {
  ...
  return (
    <div className="insights-box mt-8">
      <h4 className="text-lg font-bold green-text mb-3 flex items-center gap-2">
        <span className="inline-flex" style={neonStyle}>
          <Lightbulb size={20} strokeWidth={1.5} style={{ color: '#00FF66' }} />
        </span>
        Pro Tip del Periodo
      </h4>
      ...
      <p className="text-[var(--text-secondary)] leading-relaxed mt-4 flex items-start gap-2">
        <span className="inline-flex mt-0.5" style={neonStyle}>
          <Target size={16} strokeWidth={1.5} style={{ color: '#00FF66' }} />
        </span>
        <span>
